                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('users.store') }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input value="{{ old('confirm_password') }}" name="email"
                            ...
                            @if ($rols->isNotEmpty())
                                @foreach ($rols as $role)
                                    <div class="mt-3">
                                        ...
                                        <input {{ $hasRols->contains($role->id) ? 'checked' : '' }} type="checkbox"
                        ...
                        <button
                            class="bg-slate-700 hover:bg-slate-500 text-sm rounded-md text-white px-5 py-3">Submit</button>
                    </form>
                </div>
            </div>
        </div>
